...
class ServerShare extends React.Component {
    deviceRequestsObj;
    ...
    constructor(props) {
        ...
        this.deviceRequestsObj = new DeviceRequests()
    }

    shareDeviceData = () => {
        this.deviceRequestsObj.registerDevice(this.state.username, this.state.deviceId, this.state.userToken)
    }
...
export default connect()(ServerShare);
