...
import com.software.account.command.RegisterSmartphoneCommand;
...
import com.software.account.event.SmartphoneRegisteredEvent;
...
public class SmartPhone extends Device {
    @CommandHandler
    public SmartPhone(RegisterSmartphoneCommand command) {
        AggregateLifecycle.apply(new SmartphoneRegisteredEvent(command.getDeviceId(), command.getDeviceName()));
    }
    ...
    @EventSourcingHandler
    public void on(SmartphoneRegisteredEvent event) {
